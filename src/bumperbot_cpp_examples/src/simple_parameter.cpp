...
class SimpleParameter : public rclcpp::Node
{
    public:
        ...
        {
            declare_parameter<int>("simple_int_parameter", 25);
            declare_parameter<std::string>("simple_string_param", "TimiCpp");
    ...
    private:
        ...
        rcl_interfaces::msg::SetParametersResult paramChangeCallback(const std::vector<rclcpp::Parameter> & parameters){
            ...
            for (const auto& param : parameters){
                ...
                if (param.get_name() == "simple_string_param" and param.get_type() == rclcpp::ParameterType::PARAMETER_STRING){
